...
model_path = hf_hub_download(repo_id="opt456758/PIMA-Diabetes-Prediction", filename="best_pima_diabetes_model_v1.joblib")                                       # enter the Hugging Face username here
