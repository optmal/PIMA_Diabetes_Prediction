...
Xtrain_path = "hf://datasets/opt456758/PIMA-Diabetes-Prediction/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/opt456758/PIMA-Diabetes-Prediction/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/opt456758/PIMA-Diabetes-Prediction/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/opt456758/PIMA-Diabetes-Prediction/ytest.csv"                      # enter the Hugging Face username here
